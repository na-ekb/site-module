        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarMenu">
                <ul class="navbar-nav me-auto mb-2 mt-4 mt-xl-0">
                    ...
                    <li class="nav-item"><a @class(['nav-link', 'active' => ($page->slug == 'groups')]) href="{{ route('pages', ['slug' => 'groups']) }}">Собрания в Екатеринбурге</a></li>
                    <li class="nav-item"><a @class(['nav-link', 'active' => ($page->slug == 'region')]) href="{{ route('pages', ['slug' => 'region']) }}">Собрания в области</a></li>
