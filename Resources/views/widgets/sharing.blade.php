<hr>
<br>
<div class="share-block col-12 col-xs-12 col-lg-12">
	<span class="share-text col-12 col-xs-6 col-lg-6">
        Сохраните или поделитесь<br>
        страницей с теми кому она нужна
    </span>
    <span class="share-btns col-12 col-xs-6 col-lg-6 mt-3 mt-lg-0">
		...
		<a aria-label="Поделиться Twitter" rel="noopener" href="https://twitter.com/share?url={{ url()->current() }}hashtags=анонимныенаркоманы" data-js="reachGoal" data-goal="SHARE_TW" target="_blank">
